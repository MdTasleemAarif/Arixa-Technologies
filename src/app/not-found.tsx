  ...
  return (
    <section className="flex min-h-[80vh] items-center justify-center px-4 py-24 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-2xl text-center">
        <p className="bg-gradient-to-r from-violet-300 via-fuchsia-200 to-cyan-200 bg-clip-text text-8xl font-black tracking-tight text-transparent sm:text-9xl">
          404
        </p>
        <div className="pointer-events-none absolute inset-x-0 top-1/2 -z-10 h-48 -translate-y-1/2 bg-[linear-gradient(90deg,transparent,rgba(139,92,246,0.12),rgba(232,121,249,0.08),rgba(34,211,238,0.12),transparent)]" />
