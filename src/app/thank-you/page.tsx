  ...
  return (
    <section className="flex min-h-[80vh] items-center justify-center px-4 py-24 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-2xl text-center">
        <span className="mx-auto inline-flex h-20 w-20 items-center justify-center rounded-lg bg-indigo-500/10">
          <CheckCircle2 className="text-indigo-400" size={40} aria-hidden="true" />
        </span>
        <h1 className="mt-6 text-3xl font-semibold text-[#07304d] sm:text-4xl">
