...
export const adminResources = {
  ...
  portfolio: {
    ...
    description: "Manage project case studies and portfolio previews.",
    listFields: ["title", "slug", "category", "status"],
    fields: [
      { name: "title", label: "Title", type: "text", required: true },
      { name: "slug", label: "Slug", type: "text", required: true },
      { name: "category", label: "Category", type: "text", required: true },
      ...
      { name: "stack", label: "Stack", type: "lines" },
      { name: "image", label: "Image path", type: "text" },
      { name: "image_alt", label: "Image alt text", type: "text" },
      { name: "status", label: "Status", type: "select", options: statusOptions },
    ],
  ...
  "pricing-plans": {
    label: "Pricing Plans",
    table: "pricing_plans",
    description: "Manage package cards and CTAs.",
    listFields: ["name", "price", "sort_order", "status"],
    fields: [
      { name: "name", label: "Name", type: "text", required: true },
      { name: "slug", label: "Slug", type: "text", required: true },
